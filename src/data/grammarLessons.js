...
export const GRAMMAR_LESSONS = [
  {
    ...
    "approved": true,
    "rule": "В иврите нет глагола **«быть»** в настоящем времени — его просто опускают (сравните: по-английски dog **IS** big связку убрать нельзя, а иврит убирает её всегда).\n\nЧтобы сказать «Рекс большой» или «Майя учительница», достаточно поставить слова рядом: הַכֶּלֶב גָּדוֹל, מַיָּה מוֹרָה.\n\n> важно: это работает для общих описаний: какой предмет (большой, новый) или кто он по роли (учительница, сосед). Если же речь об одном конкретном, уже известном предмете — нужно другое слово, оно ниже.",
    "examples": [
      {
    ...
    "practiceItems": [
      ...
      {
        "type": "В4",
        "prompt": "Что нужно вставить между דָּנִיֵּאל и אַבָּא, чтобы сказать «Даниэль — папа»?",
        "options": [
    ...
    "notes": "Для конкретного, уже известного предмета («Рекс — вот эта наша собака») добавляется слово-связка הוּא — разберём его в отдельном уроке."
  },
  {
    "id": "M1.1",
    "seq": 21,
  ...
  },
  {
    ...
    "generatesReading": true,
    "approved": true,
    "rule": "Обычно артикль добавляет ה с патахом и удваивает следующую букву: הַכֶּלֶב. Но буквы א, ה, ח, ע — гортанные, дагеш в них не ставится, поэтому правило меняется. Перед א и ה артикль пишется הָ: הָאִישָּׁה, הָאֵם. Перед ח и ע — הֶ (сеголь, звук «э»): הֶחָלָב, הֶעָנָן. Сразу сними вопрос, который здесь возникает у всех: הַ и הָ в современном иврите звучат ОДИНАКОВО — «ха». Разницы на слух нет, она только в написании. Поэтому выбирать значок приходится по правилу, а не по звуку. Тонкость: перед ע это работает при камаце (עָ); если под ע другая огласовка — артикль הָ: הָעִיר («тот город»).",
    "examples": [
      {
  ...
  },
  {
    ...
    "practiceItems": [
      ...
      {
        "type": "В4",
        "prompt": "Тамар рассказывает папе о своей учительнице: «___ дома». Выбери правильную форму «та большая учительница» (מוֹרָה — женский род).",
        "options": [
          "הַמּוֹרָה הַגָּדוֹל",
  ...
  },
  {
    ...
    "approved": true,
    "rule": "Ивритские слова строятся как конструктор: КОРЕНЬ + ШАБЛОН = слово. Корень — это 3 буквы, несущие смысл. Шаблон (биньян) — это форма, в которую корень «вставляется». Тамар удивляется: корень ה-ל-כ (идея «ходить») + шаблон паАль = הוֹלֵךְ (идёт). Корень א-כ-ל (идея «еды») + тот же шаблон = אוֹכֵל (ест). Корень א-ה-ב + паАль = אוֹהֵב (любит). Смотри: у всех один рисунок огласовок — «о-э» (◌וֹ◌ֵ◌). Ты уже знаешь эти слова из словаря — теперь ты видишь, КАК они устроены! Это первый и главный биньян — паАль. Особый случай — ש-ת-ה (пить) → שׁוֹתֶה: в мужском роде рисунок тот же «о-э», но корень «на ה» (ל\"ה) — дальше по курсу увидишь, что в женском роде и множественном числе он меняется иначе, чем обычные корни. Тест не нужен: просто пойми идею конструктора.",
    "examples": [
      {
  ...
  },
  {
    ...
    "generatesReading": true,
    "approved": true,
    "rule": "Женская форма настоящего времени: добавляем окончание ־ֶת. הוֹלֵךְ → הוֹלֶכֶת (идёт — о женщине), אוֹכֵל → אוֹכֶלֶת, יוֹשֵׁב → יוֹשֶׁבֶת. Заметь: огласовки внутри слова меняются («о-э» → «о-э-э»). Майя говорит о себе: אֲנִי הוֹלֶכֶת. И снова одна форма на я/ты/она: אֲנִי / אַתְּ / הִיא הוֹלֶכֶת. Глаголы на ־ֶה меняют его на ־ָה: שׁוֹתֶה → שׁוֹתָה, רוֹצֶה → רוֹצָה. А גָּר просто добавляет ־ָה: גָּרָה.",
    "examples": [
      {
  ...
  },
  {
    ...
    "generatesReading": true,
    "approved": true,
    "rule": "Ещё один подарок иврита: чтобы задать вопрос «да/нет», НИЧЕГО не меняется в порядке слов! אַתָּה רוֹצֶה מִיץ — «ты хочешь сок» (утверждение). אַתָּה רוֹצֶה מִיץ? — «ты хочешь сок?» (вопрос). Разница только в интонации: голос идёт вверх в конце. На письме — просто знак вопроса. Майя за завтраком: אַתָּה אוֹכֵל? — Ноам: כֵּן, אֲנִי אוֹכֵל. Никаких «ли», никакой перестановки слов — сказал с вопросительной интонацией, и это вопрос.",
    "examples": [
      {
  ...
  },
  {
    ...
    "generatesReading": true,
    "approved": true,
    "rule": "Завершаем первую десятку — женские 6–10: שֵׁשׁ (6), שֶׁבַע (7), שְׁמוֹנֶה (8), תֵּשַׁע (9), עֶשֶׂר (10). Как и 1–5, женские формы короче мужских — обратная логика продолжается. Теперь ты можешь считать до десяти «просто так» (счёт всегда в женском роде): אַחַת, שְׁתַּיִם, שָׁלֹשׁ, אַרְבַּע, חָמֵשׁ, שֵׁשׁ, שֶׁבַע, שְׁמוֹנֶה, תֵּשַׁע, עֶשֶׂר! Тамар считает Ноаму перед игрой в прятки.",
    "examples": [
      {
        "hebrew": "שֵׁשׁ",
        "translit": "шеш",
  ...
  },
  {
    ...
    "generatesReading": true,
    "approved": true,
    "rule": "У самых частых слов множественное число — с сюрпризами. Полная замена слова: אִישָּׁה → נָשִׁים (женщина → женщины), אִישׁ → אֲנָשִׁים (мужчина → люди). Женские слова с «мужским» окончанием: עִיר → עָרִים (город → города — слово ж.р., а окончание ־ִים!). И сильная смена огласовок: בַּיִת → בָּתִּים. Эти слова надо просто запомнить — они встречаются каждый день.",
    "examples": [
      {
  ...
  },
  {
    ...
    "generatesReading": true,
    "approved": true,
    "rule": "Предлог בְּ значит «в» или «на» и пишется СЛИТНО со словом: בְּבַיִת — в доме (каком-то). Главный фокус — слияние с артиклем: בְּ + הַבַּיִת = בַּבַּיִת (в ЭТОМ доме). Артикль ה исчезает, но оставляет свою огласовку предлогу: бэ+ха → ба. Ты уже видел это в фразах: הוּא גָּר בַּבַּיִת. Теперь понятно, откуда взялось בַּ!",
    "examples": [
      {
        "hebrew": "בְּבַיִת",
        "translit": "бэ-байт",
  ...
  },
  {
    ...
    "generatesReading": true,
    "approved": true,
    "rule": "Предлог לְ значит «к» или «для» и тоже пишется слитно: לְבַיִת — к (какому-то) дому. Слияние с артиклем — по той же схеме, что и בְּ: לְ + הַבַּיִת = לַבַּיִת (к этому дому). ⚠️ Но обычное «домой» — это НЕ לַבַּיִת! Есть отдельное слово-исключение הַבַּיְתָה (hа-байта): окончание ־ָה само значит «туда, в направлении», и לְ тут не нужен вообще. לַבַּיִת — грамматически верное «к дому» (это и есть правило לְ+הַ, которое мы разбираем), но живое «иду домой» иврит говорит через הַבַּיְתָה. Знакомое לִי (мне) из урока יֵשׁ — это тот же לְ с суффиксом «я»!",
    "examples": [
      {
    ...
    "practiceItems": [
      ...
      {
        "type": "В4",
        "prompt": "«Я иду к (этому) дому» (м.р., через לְ+הַ)?",
        "options": [
  ...
  },
  {
    ...
    "generatesReading": true,
    "approved": true,
    "rule": "Третий предлог-приставка: מִ значит «из» или «от». מִתֵּל אָבִיב — из Тель-Авива. Самая нужная фраза каждого оле: אֲנִי מֵרוּסְיָה — я из России! Перед гортанными и ר предлог звучит מֵ (мэ). С артиклем: מִ + הַבַּיִת = מֵהַבַּיִת — здесь артикль НЕ исчезает (в отличие от בְּ и לְ), меняется только огласовка предлога.",
    "examples": [
      {
  ...
  },
  {
    ...
    "generatesReading": true,
    "approved": true,
    "rule": "Из урока יֵשׁ ты знаешь пять форм: לִי (мне), לְךָ (тебе, м.), לָךְ (тебе, ж.), לוֹ (ему), לָהּ (ей). Достраиваем множественное число: לָנוּ (нам), לָכֶם (вам), לָהֶם (им). Всё это — предлог לְ + суффикс лица. Так работают в иврите ВСЕ предлоги: не «к я», а «ко-мне» одним словом. Майя: יֵשׁ לָנוּ בַּיִת — у нас есть дом!",
    "examples": [
      {
  ...
  },
  {
    ...
    "generatesReading": true,
    "approved": true,
    "rule": "Когда слово определённое, артикль получают ОБА: и существительное, и прилагательное. הַכֶּלֶב הַגָּדוֹל — та большая собака (буквально «та-собака та-большая»). Сравни: כֶּלֶב גָּדוֹל — какая-то большая собака; הַכֶּלֶב הַגָּדוֹל — тот самый Рекс. Если артикль один — смысл меняется: הַכֶּלֶב גָּדוֹל — это уже предложение «(эта) собака — большая» (помнишь C0?).",
    "examples": [
      {
        "hebrew": "הַכֶּלֶב הַגָּדוֹל",
  ...
  },
  {
    ...
    "examples": [
      ...
      },
      {
        "hebrew": "אֶת ≠ אַתְּ",
        "translit": "эт ≠ ат",
        "ru": "את-маркер ≠ «ты, ж.р.» — разные слова!",
        "isNew": false,
        "audio": "ex_m29_5.mp3",
        "gender": "m"
      },
  ...
  },
  {
    ...
    "generatesReading": true,
    "approved": true,
    "rule": "Глаголы во множественном числе получают те же окончания, что и существительные! Мужской род: ־ִים. הוֹלֵךְ → הוֹלְכִים (идут), אוֹכֵל → אוֹכְלִים (едят). Цере выпадает: hолЕх → hолХим. Работает для «мы», «вы», «они»: אֲנַחְנוּ הוֹלְכִים — мы идём, הֵם אוֹכְלִים — они едят. Вся семья: אֲנַחְנוּ הוֹלְכִים לָעִיר!",
    "examples": [
      {
  ...
  },
  {
    ...
    "generatesReading": true,
    "approved": true,
    "rule": "Женское множественное у глаголов — окончание ־וֹת: הוֹלֵךְ → הוֹלְכוֹת (идут — о женщинах), אוֹכֵל → אוֹכְלוֹת. Новое местоимение: הֵן — «они» о женщинах. Майя и Тамар выходят: הֵן הוֹלְכוֹת לָעִיר. Если в группе есть хоть один мужчина — используется мужская форма ־ִים.",
    "examples": [
      {
  ...
  },
  {
    ...
    "generatesReading": true,
    "approved": true,
    "rule": "Собираем всё настоящее время в одну картину. У любого глагола РОВНО 4 формы: м.ед. הוֹלֵךְ · ж.ед. הוֹלֶכֶת · м.мн. הוֹלְכִים · ж.мн. הוֹלְכוֹת. Кто говорит — неважно (я/ты/он, мы/вы/они): выбирай форму по роду и числу. Глаголы на ־ֶה: שׁוֹתֶה · שׁוֹתָה · שׁוֹתִים · שׁוֹתוֹת. Это ВСЁ настоящее время иврита — 4 клетки!",
    "examples": [
      {
  ...
  },
  {
    ...
    "generatesReading": true,
    "approved": true,
    "rule": "Волшебная частица שֶׁ־ значит «который/которая/которые» — и НЕ меняется никогда! Пишется слитно со следующим словом: הַכֶּלֶב שֶׁאֲנִי אוֹהֵב — собака, которую я люблю. הָעוּגָה שֶׁמַּיָּה אוֹפָה... стоп, «печёт» мы ещё не знаем — הָעוּגָה שֶׁאֲנִי אוֹכֵל — торт, который я ем. Одно שֶׁ на все рода и числа — сравни с русскими «который/которая/которое/которые»!",
    "examples": [
      {
  ...
  },
  {
    ...
    "generatesReading": false,
    "approved": true,
    "rule": "Точка внутри буквы — это дагеш. Ты уже видел её много раз: בַּיִת, גַּג, כֶּלֶב. Дагеш бывает двух видов. Дагеш-лёгкий (кал) меняет ЗВУК буквы — но только у шести особых букв. Дагеш-сильный (хазак) удваивает букву: звук тот же, но как бы двойной (הַכֶּלֶב звучит почти «hаккэлев»). Пока просто запомни главное: точка в букве — не случайность и не украшение, у неё всегда есть работа. В следующих уроках разберём оба вида.",
    "examples": [
      {
        "hebrew": "בַּיִת",
        "translit": "báyit",
  ...
  },
  {
    ...
    "generatesReading": false,
    "approved": true,
    "rule": "Шва — две точки под буквой (значок ◌ְ, как в בְּ) — знак-хамелеон. Чаще всего оно НЕМОЕ: показывает конец слога и само не читается. מַלְכָּה = «мал-ка» (не «малэка»): шва под ל просто закрывает слог «мал». Ты уже читал немое шва, не зная его имени: в יַלְדָּה («ял-да»), в הוֹלֵךְ («hо-лех» — шва под последней буквой, слог просто закрыт). Правило: если шва стоит после гласной в середине слова — оно немое, слог закрывается.",
    "examples": [
      {
        "hebrew": "מַלְכָּה",
        "translit": "мал-ка",
  ...
  },
  {
    ...
    "generatesReading": false,
    "approved": true,
    "rule": "То же самое шва бывает и ПОДВИЖНЫМ — тогда оно читается как краткое «э». Это происходит в начале слова: שְׁלֹשָׁה = «шэ-ло-ша», שְׁכֵנָה = «шэ-хе-на», גְּדוֹלָה = «гэ-до-ла». Но честно предупредим сразу: в живой израильской речи это «э» почти всегда проглатывают — слышно «шлоша», «шхена», «гдола». Правило нужно, чтобы понимать огласовки и не спотыкаться при чтении; на слух же ориентируйся на разговорный вариант. Сравни с прошлым уроком: в מַלְכָּה шва немое (середина слова), а в שְׁלֹשָׁה — подвижное (начало слова). Простое правило для старта: шва в начале слова → читай «э»; шва в середине после гласной → молчит.",
    "examples": [
      {
        "hebrew": "שְׁלֹשָׁה",
        "translit": "шэ-ло-ша",
...
export const GRAMMAR_MODULES = [
  ...
  { id: 'wordsystem', name: 'Система слова', icon: '🧬' },
];
